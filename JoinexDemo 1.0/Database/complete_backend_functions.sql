-- Complete Backend Functions for JoinexDemo (CONSOLIDATED VERSION)
-- This file combines location search, sport management, and event filtering without repetition
...
-- Common event return type (defined once to avoid repetition)
CREATE OR REPLACE FUNCTION get_event_return_type()
RETURNS TABLE (
    id UUID,
    title TEXT,
    description TEXT,
...
AS $$
BEGIN
    -- This function is used as a template for other functions
    -- It's not meant to be called directly
    RAISE EXCEPTION 'This function is a template and should not be called directly';
END;
$$;
...
-- ============================================================================
-- 7. EVENT FILTERING FUNCTIONS (CONSOLIDATED)
-- ============================================================================
...
-- ============================================================================
-- 8. EVENT CREATION WITH VALIDATION
-- ============================================================================

-- Create event with sport validation
